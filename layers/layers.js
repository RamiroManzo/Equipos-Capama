...
lyr_Puntosapartirdetabla_2.set('fieldAliases', {'No.': 'No.', 'Planta de tratamiento': 'Planta de tratamiento', 'Gasto de diseño': 'Gasto de diseño', 'Gasto de Operación': 'Gasto de Operación', 'Equipos Instalados': 'Equipos Instalados', 'Hps Instalados': 'Hps Instalados', 'Equipos Fuera de Servicio': 'Equipos Fuera de Servicio', 'kWH Promedio': 'kWH Promedio', 'LATITUD': 'LATITUD', 'LONGITUD': 'LONGITUD', });
lyr_Puntosapartirdetabla_3.set('fieldAliases', {'No. INVENTARIO': 'No. INVENTARIO', 'ESTACION': 'ESTACION', 'No. INST.': 'No. INST.', 'CAP. EN HP': 'CAP. EN HP', 'TOTAL EN HP': 'TOTAL EN HP', 'DISPONIBLES': 'DISPONIBLES', 'FUERA DE SERVICIO': 'FUERA DE SERVICIO', 'OBSERVACIONES': 'OBSERVACIONES', 'LATITUD': 'LATITUD', 'LONGITUD': 'LONGITUD', });
...
lyr_Puntosapartirdetabla_2.set('fieldImages', {'No.': '', 'Planta de tratamiento': '', 'Gasto de diseño': '', 'Gasto de Operación': '', 'Equipos Instalados': '', 'Hps Instalados': '', 'Equipos Fuera de Servicio': '', 'kWH Promedio': '', 'LATITUD': '', 'LONGITUD': '', });
lyr_Puntosapartirdetabla_3.set('fieldImages', {'No. INVENTARIO': '', 'ESTACION': '', 'No. INST.': '', 'CAP. EN HP': '', 'TOTAL EN HP': '', 'DISPONIBLES': '', 'FUERA DE SERVICIO': '', 'OBSERVACIONES': '', 'LATITUD': '', 'LONGITUD': '', });
lyr_Puntosapartirdetabla_1.set('fieldLabels', {'No. INVENTARIO': 'inline label', 'ESTACION': 'inline label', 'No. INST.': 'no label', 'CAP. EN HP': 'inline label', 'TOTAL EN HP': 'inline label', 'DISPONIBLES': 'inline label', 'FUERA DE SERVICIO': 'inline label', 'OBSERVACIONES': 'inline label', 'LATITUD': 'inline label', 'LONGITUD': 'inline label', });
lyr_Puntosapartirdetabla_2.set('fieldLabels', {'No.': 'inline label', 'Planta de tratamiento': 'inline label', 'Gasto de diseño': 'inline label', 'Gasto de Operación': 'inline label', 'Equipos Instalados': 'inline label', 'Hps Instalados': 'inline label', 'Equipos Fuera de Servicio': 'inline label', 'kWH Promedio': 'inline label', 'LATITUD': 'inline label', 'LONGITUD': 'inline label', });
lyr_Puntosapartirdetabla_3.set('fieldLabels', {'No. INVENTARIO': 'inline label', 'ESTACION': 'inline label', 'No. INST.': 'inline label', 'CAP. EN HP': 'inline label', 'TOTAL EN HP': 'inline label', 'DISPONIBLES': 'inline label', 'FUERA DE SERVICIO': 'inline label', 'OBSERVACIONES': 'inline label', 'LATITUD': 'inline label', 'LONGITUD': 'inline label', });
