...
lyr_Puntosapartirdetabla_3.set('fieldAliases', {'No.': 'No.', 'ESTACION': 'ESTACION', 'Gasto de diseño': 'Gasto de diseño', 'Gasto de Operación': 'Gasto de Operación', 'Equipos Instalados': 'Equipos Instalados', 'Hps Instalados': 'Hps Instalados', 'Equipos Fuera de Servicio': 'Equipos Fuera de Servicio', 'LATITUD': 'LATITUD', 'LONGITUD': 'LONGITUD', });
...
lyr_Puntosapartirdetabla_3.set('fieldImages', {'No.': '', 'ESTACION': '', 'Gasto de diseño': '', 'Gasto de Operación': '', 'Equipos Instalados': '', 'Hps Instalados': '', 'Equipos Fuera de Servicio': '', 'LATITUD': '', 'LONGITUD': '', });
...
lyr_Puntosapartirdetabla_3.set('fieldLabels', {'No.': 'no label', 'ESTACION': 'inline label', 'Gasto de diseño': 'inline label', 'Gasto de Operación': 'inline label', 'Equipos Instalados': 'inline label', 'Hps Instalados': 'inline label', 'Equipos Fuera de Servicio': 'inline label', 'LATITUD': 'inline label', 'LONGITUD': 'inline label', });
